ActiveAdmin.register Delivery do
  ...
  form do |f|
    ...
    f.inputs "Delivery" do
      ...
      f.input :course, as: :select, :collection => ["Full Course + Pendrive", "Physics Course + Pendrive", "Chemistry Course + Pendrive", "Biology Course + Pendrive", "Physics + Biology + Pendrive", "Chemistry + Biology + Pendrive", "Physics + Chemistry + Pendrive", "Dongle Only", "9th Class Course + Pendrive", "10th Class Course + Pendrive"]
