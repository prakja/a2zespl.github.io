ActiveAdmin.register Delivery do
  ...
  form do |f|
    ...
    f.inputs "Delivery" do
      ...
      f.input :course, as: :select, :collection => ["Full Course + Pendrive", "Physics Course + Pendrive", "Chemistry Course + Pendrive", "Biology Course + Pendrive", "Physics + Biology + Pendrive", "Chemistry + Biology + Pendrive", "Physics + Chemistry + Pendrive", "Dongle Only", "9th Class Course + Pendrive", "10th Class Course + Pendrive", "11th Class Course + Pendrive", "12th Class Course + Pendrive", "NEET Physics Video Module - Mechanics", "NEET Physics Video Module - Properties of Bulk Matter & Heat", "NEET Physics Video Module - Electrodynamics & Magnetism", "NEET Physics Video Module - Optics & Modern Physics", "NEET Chemistry Video Module - Physical Chemistry", "NEET Chemistry Video Module - Inorganic Chemistry", "NEET Chemistry Video Module - Organic Chemistry", "NEET Biology Video Module - Human Physiology", "NEET Biology Video Module - Plant Physiology", "NEET Biology Video Module - Diversity", "NEET Biology Video Module - Genetics", "NEET Biology Video Module - Biotechnolology & Ecology"]
