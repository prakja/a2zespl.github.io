  ...
  form do |f|
    ...
    f.inputs "Question" do
      ...
      f.input :video_sentence_ids, input_html: {id: "question_video_sentences_select2"}, label: "Video Sentence", as: :selected_list,
        ...
        fields: [:sentence], display_name: 'sentenceContext', predicate: 'matches_regexp', minimum_input_length: 5, hint: raw("<a href='#{admin_videos_path(order: 'seqId_asc_and_id_asc', q: {videoTopics_chapterId_eq: f.object.topicId, language: 'hinglish'})}' target='_blank'>Chapter Videos</a> List used for linking") if f.object.topicId.present?
