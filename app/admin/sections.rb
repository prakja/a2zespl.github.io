ActiveAdmin.register Section do
  permit_params :name, :topic, :chapterId, :seqNum, :ncertName, :ncertURL, :ncertSectionLink, contents_attributes: [:id, :title, :contentType, :contentId, :seqNum, :_destroy]
