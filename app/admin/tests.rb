...
index do
  ...
  column ("All Questions") {|test| link_to 'All Test Questions', "../../admin/questions?order=sequenceId_asc&showProofRead=yes&q[questionTests_testId_eq]=" + test.id.to_s}
...
action_item :show_question, only: :show do
  link_to 'All Test Questions', "../../admin/questions?order=sequenceId_asc&showProofRead=yes&q[questionTests_testId_eq]=" + resource.id.to_s
end
