ActiveAdmin.register Topic do
  ...
  member_action :duplicate_questions do
    ...
    limit = params[:limit].to_i > 0 ? " limit " + params[:limit].to_s : ""
    match_subtopic = params[:match_subtopic].present? ? ' and exists (select "subTopicId" from "QuestionSubTopic" "QuestionSubTopic1" where "QuestionSubTopic1"."questionId" = "Question1"."id" intersect select "subTopicId" from "QuestionSubTopic" "QuestionSubTopic2" where "QuestionSubTopic2"."questionId" = "Question"."id")' : ""
    match_length = params[:length_tolerance].present? ? ' and length("Question"."question") between ' + (1 - params[:length_tolerance].to_f).to_s + '  * length("Question1"."question") and ' + (1 + params[:length_tolerance].to_f).to_s + ' * length("Question1"."question")' : "";
    mod_cond = params[:apply_mod_ten].present? ? ' and mod("Question"."id", 10) = ' + params[:apply_mod_ten].to_s + ' ' : "";
    mod_cond += params[:apply_mod_three].present? ? ' and mod("Question"."id", 3) = ' + params[:apply_mod_three].to_s + ' ' : "";
    if params[:questionId1].blank? and params[:questionId2].blank? and params[:show_duplicates].blank?
      @question_pairs = ActiveRecord::Base.connection.query('Select "Question"."id", "Question"."question", "Question1"."id", "Question1"."question", "Question"."correctOptionIndex", "Question1"."correctOptionIndex", "Question"."options", "Question1".options, replace("Question"."explanation", \'<iframe\', \'<iframe loading="lazy"\'), replace("Question1"."explanation", \'<iframe\', \'<iframe loading="lazy"\') from "ChapterQuestion" INNER JOIN "Question" ON "Question"."id" = "ChapterQuestion"."questionId" and "Question"."deleted" = false and "Question"."type" = \'MCQ-SO\' and "ChapterQuestion"."chapterId" = ' + resource.id.to_s + mod_cond + ' INNER JOIN "ChapterQuestion" AS "ChapterQuestion1" ON "ChapterQuestion1"."chapterId" = "ChapterQuestion"."chapterId" and "ChapterQuestion"."questionId" < "ChapterQuestion1"."questionId" INNER JOIN "Question" AS "Question1" ON "Question1"."id" = "ChapterQuestion1"."questionId" and "Question1"."deleted" = false and "Question1"."type" = \'MCQ-SO\' and not exists (select * from "NotDuplicateQuestion" where "questionId1" = "Question"."id" and "questionId2" = "Question1"."id") and not exists (select * from "DuplicateQuestion" where "questionId1" = "Question"."id" and "questionId2" = "Question1"."id") and similarity("Question1"."question", "Question"."question") > ' + cutoff + ' and "ChapterQuestion1"."chapterId" = ' + resource.id.to_s + match_subtopic + match_length + limit);
    elsif params[:questionId1].blank? and params[:questionId2].blank? and params[:show_duplicates].present?
      @question_pairs = ActiveRecord::Base.connection.query('Select "Question"."id", "Question"."question", "Question1"."id", "Question1"."question", "Question"."correctOptionIndex", "Question1"."correctOptionIndex", "Question"."options", "Question1".options, replace("Question"."explanation", \'<iframe\', \'<iframe loading="lazy"\'), replace("Question1"."explanation", \'<iframe\', \'<iframe loading="lazy"\') from "ChapterQuestion" INNER JOIN "Question" ON "Question"."id" = "ChapterQuestion"."questionId" and "Question"."deleted" = false and "Question"."type" = \'MCQ-SO\' and "ChapterQuestion"."chapterId" = ' + resource.id.to_s + mod_cond + ' INNER JOIN "ChapterQuestion" AS "ChapterQuestion1" ON "ChapterQuestion1"."chapterId" = "ChapterQuestion"."chapterId" and "ChapterQuestion"."questionId" < "ChapterQuestion1"."questionId" INNER JOIN "Question" AS "Question1" ON "Question1"."id" = "ChapterQuestion1"."questionId" and "Question1"."deleted" = false and "Question1"."type" = \'MCQ-SO\' and not exists (select * from "NotDuplicateQuestion" where "questionId1" = "Question"."id" and "questionId2" = "Question1"."id") and similarity("Question1"."question", "Question"."question") > ' + cutoff + ' and "ChapterQuestion1"."chapterId" = ' + resource.id.to_s + match_length + match_subtopic + limit);
    else
      @question_pairs = ActiveRecord::Base.connection.query('Select "Question"."id", "Question"."question", "Question1"."id", "Question1"."question", "Question"."correctOptionIndex", "Question1"."correctOptionIndex", "Question"."options", "Question1".options, "Question"."explanation", "Question1"."explanation" from "Question", "Question" AS "Question1" where "Question"."id" = ' + params[:questionId1] + ' and "Question1"."id" = ' + params[:questionId2] + limit);
    end
  end
