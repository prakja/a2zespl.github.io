class Ability
  ...
  def initialize(user)
    if user.role == 'admin'
      ...
      can :manage, SubTopic
      can :read, [UserProfile, User, Notification, SubjectLeaderBoard, TopicLeaderBoard, CommonLeaderBoard, TestLeaderBoard, Answer, CourseTest, Topic, CustomerIssueType]
