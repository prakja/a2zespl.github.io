class Doubt < ApplicationRecord
  ...
  scope :botany_paid_student_doubts, -> {solved('no').paid([8, 141, 20, 149], 'yes').deleted('no').subject_name([53, 478, 132, 495]).distinct}
  scope :chemistry_paid_student_doubts, -> {solved('no').paid([8, 141, 19, 149], 'yes').deleted('no').subject_name([54, 477, 129, 494]).distinct}
  scope :physics_paid_student_doubts, -> {solved('no').paid([8, 141, 18, 149], 'yes').deleted('no').subject_name([55, 476, 126, 493]).distinct}
  scope :zoology_paid_student_doubts, -> {solved('no').paid([8, 141, 20, 149], 'yes').deleted('no').subject_name([56, 479, 135, 496]).distinct}
