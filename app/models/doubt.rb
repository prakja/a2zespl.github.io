class Doubt < ApplicationRecord
  ...
  scope :botany_paid_student_doubts, -> {solved('no').paid([8, 141, 20, 100, 149, 51], 'yes').deleted('no').subject_name([53, 478, 132, 390, 495, 222]).distinct}
  scope :chemistry_paid_student_doubts, -> {solved('no').paid([8, 141, 19, 100, 149, 51], 'yes').deleted('no').subject_name([54, 477, 129, 391, 494, 229]).distinct}
  scope :physics_paid_student_doubts, -> {solved('no').paid([8, 141, 18, 100, 149, 51], 'yes').deleted('no').subject_name([55, 476, 126, 392, 493, 232]).distinct}
  scope :zoology_paid_student_doubts, -> {solved('no').paid([8, 141, 20, 100, 149, 51], 'yes').deleted('no').subject_name([56, 479, 135, 393, 496, 234]).distinct}
