class TestLeaderBoard < ApplicationRecord
  ...
  scope :high_yield_paid_students, -> {where(UserCourse.where('"UserCourse"."userId" = "TestLeaderBoard"."userId" and "UserCourse"."courseId" in (270,288,289)').limit(1).arel.exists)}
