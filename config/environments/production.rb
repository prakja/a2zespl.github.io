Rails.application.configure do
  ...
  config.node_site_url = 'https://www.neetprep.com/'
  ...
  # config.active_job.queue_name_prefix = "RubyActiveAdmin_#{Rails.env}"
  ...
  config.site_url_for_socket = ENV["WEBSITE_URL"].to_s + ":5000/"
end
