...
ActiveRecord::Schema.define(version: 2020_01_31_070012) do
...
#   Unknown type 'mpaa_rating' for column 'rating'
  ...
  create_table "payment", id: false, force: :cascade do |t|
    t.serial "payment_id", null: false
  ...
  create_table "payment_p2017_01", id: false, force: :cascade do |t|
    ...
    t.index ["customer_id"], name: "payment_p2017_01_customer_id_idx"
  ...
  create_table "payment_p2017_02", id: false, force: :cascade do |t|
    ...
    t.index ["customer_id"], name: "payment_p2017_02_customer_id_idx"
  ...
  create_table "payment_p2017_03", id: false, force: :cascade do |t|
    ...
    t.index ["customer_id"], name: "payment_p2017_03_customer_id_idx"
  ...
  create_table "payment_p2017_04", id: false, force: :cascade do |t|
    ...
    t.index ["customer_id"], name: "payment_p2017_04_customer_id_idx"
  ...
  create_table "payment_p2017_05", id: false, force: :cascade do |t|
    ...
    t.index ["customer_id"], name: "payment_p2017_05_customer_id_idx"
  ...
  create_table "payment_p2017_06", id: false, force: :cascade do |t|
    ...
    t.index ["customer_id"], name: "payment_p2017_06_customer_id_idx"
